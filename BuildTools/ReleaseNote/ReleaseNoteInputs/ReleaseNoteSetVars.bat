...
set TEST_DOCUMENT_TITLE=ICONIS ATS Riyadh_IDP RELEASE
set INDEX_DOC_FILE_NAME=ReleaseNote_XXXXX_ICONIS_Riyadh_IDP.doc
set TEMPLATE_DIR=..\CodingRules\Template\
set PROJECT_NAME=ICONIS ATS Riyadh_IDP
